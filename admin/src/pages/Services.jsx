...
const Services = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!sanitized.title) {
      showToast('Title reqiured', 'error');
      return;
    }
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      ...
                      className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full cursor-pointer hover:opacity-80 ${category.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                        }`}
                  ...
                  <tr key={service._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        ...
                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full cursor-pointer hover:opacity-80 ${service.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                          }`}
